document.addEventListener('DOMContentLoaded', () => {
    ...
    calculateBtn.addEventListener('click', async () => {
        ...
        const disclaimerHTML = `
            ...
            <p style="font-size: 0.85em; color: #000; line-height: 1.4;">
                <i class="fa-solid fa-circle-info" style="color: #FCD34D;"></i> <strong>Note:</strong> Parking cost, toll booth charges, and state permits are not included in the company cost. These costs must be borne by the user during the trip.
            </p>
        `;
        details += disclaimerHTML;
